...
class TestOutcome(unittest, TestCase):
	...
	def test__hash__(self):
		self.assertEqual(outcome.Outcome('red',18)==hash(outcome.Outcome('red',18),False))
		self.assertEqual(outcome.Outcome('red',18)==hash(outcome.Outcome('red',17),False))
		self.assertEqual(outcome.Outcome('red',18)==hash(outcome.Outcome('blue',17),True))
		self.assertEqual(outcome.Outcome('red',18)==hash(outcome.Outcome('blue',18),True))
