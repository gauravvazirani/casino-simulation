...
class BinBuilder(IBuilder):
	...
	def generateStraightBets(self):
		...
		self.wheel.addOutcome(0,Outcome('Number 0', Roulette.StraightBet))
		self.wheel.addOutcome(00,Outcome('Number 00', Roulette.StraightBet))
		return self
...
			self.wheel.addOutcome(
	...
	def generateSpecialBets(self):
		...
		self.wheel.addOutcome(00,Outcome('00-0-1-2-3',6))
		return self
